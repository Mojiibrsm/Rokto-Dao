...
import { Loader2, Search, Edit, Trash2, ArrowLeft, Save, Phone, Mail } from 'lucide-react';
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow><TableCell colSpan={4} className="h-32 text-center text-muted-foreground">কোনো তথ্য পাওয়া যায়নি।</TableCell></TableRow>
            ) : (
