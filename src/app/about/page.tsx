...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col gap-0 pb-12">
      {/* 1. Hero Section */}
      <section className="relative py-12 md:py-20 bg-primary/5 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center space-y-4">
          <Badge className="bg-primary/10 text-primary border-primary/20 text-xs py-1 px-4 rounded-full">আমাদের লক্ষ্য ও পথচলা</Badge>
          <h1 className="text-3xl md:text-5xl font-black font-headline tracking-tight text-foreground leading-tight">
      ...
      <section className="py-12 container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="rounded-[2.5rem] p-6 border-none shadow-xl bg-white group hover:shadow-primary/5 transition-all">
            <CardHeader className="space-y-3">
              ...
              <CardTitle className="text-2xl font-bold">আমাদের মিশন</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="rounded-[2.5rem] p-6 border-none shadow-xl bg-white group hover:shadow-secondary/5 transition-all">
            <CardHeader className="space-y-3">
              <div className="h-14 w-14 rounded-2xl bg-secondary/10 flex items-center justify-center text-secondary group-hover:bg-secondary group-hover:text-white transition-all duration-500">
                <Globe className="h-7 w-7" />
              </div>
              <CardTitle className="text-2xl font-bold">আমাদের ভিশন</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-base text-muted-foreground leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-bold font-headline leading-tight">একটি মানবিক স্বপ্নের বাস্তবায়ন</h2>
              <p className="text-base text-muted-foreground leading-relaxed">
              ...
              <div className="p-6 bg-white rounded-3xl border border-primary/10 shadow-lg relative">
                <p className="text-lg italic font-medium text-foreground/80 mb-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="h-14 w-14 rounded-full border-4 border-primary/20 overflow-hidden relative">
                    <Image 
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-primary">মুজিবুর রহমান</h4>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider">প্রতিষ্ঠাতা, RoktoDao</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative order-1 lg:order-2 flex justify-center">
              ...
              <Image 
                ...
                className="rounded-[3rem] shadow-2xl relative z-10 object-cover"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 space-y-2">
            <h2 className="text-3xl font-bold font-headline">আমাদের মূল মূল্যবোধ</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center space-y-4 p-8 rounded-[2.5rem] bg-muted/10 hover:bg-primary/5 transition-all duration-500">
                <div className="h-16 w-16 rounded-3xl bg-white shadow-md flex items-center justify-center mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center space-y-2">
                <div className="h-12 w-12 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center mx-auto mb-2">
                  <stat.icon className="h-6 w-6 text-white" />
                </div>
                <div className="text-3xl md:text-4xl font-black font-headline">{stat.val}</div>
      ...
      {/* 6. Join Us CTA */}
      <section className="py-16 bg-white text-center space-y-8">
        <div className="max-w-3xl mx-auto space-y-4 px-4">
          <div className="h-16 w-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto text-primary">
            <Heart className="h-8 w-8 fill-primary" />
          </div>
          <h2 className="text-3xl md:text-4xl font-bold font-headline">আপনিও কি জীবন বাঁচাতে চান?</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            একজন দাতা হিসেবে আজই নিবন্ধন করুন অথবা আমাদের এই মানবিক কার্যক্রম অন্যদের সাথে শেয়ার করুন।
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="rounded-full px-10 h-12 text-lg font-bold bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20" asChild>
              <Link href="/register">নিবন্ধন করুন <ArrowRight className="ml-2 h-5 w-5" /></Link>
            </Button>
            <Button size="lg" variant="outline" className="rounded-full px-10 h-12 text-lg font-bold border-primary text-primary hover:bg-primary/5" asChild>
