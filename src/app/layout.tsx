    ...
    <html lang="bn" suppressHydrationWarning>
      ...
      <body className="font-body antialiased min-h-screen bg-background flex flex-col" suppressHydrationWarning>
        ...
        <div className="fixed bottom-8 right-8 z-40">
           <Link href="/requests/new" className="bg-primary text-white px-8 py-4 rounded-full shadow-2xl font-bold hover:bg-primary/90 transition-all flex items-center gap-3 transform hover:scale-105 active:scale-95 group">
             <Droplet className="h-6 w-6 fill-white group-hover:animate-bounce" />
             <span className="text-lg">রক্তের অনুরোধ</span>
           </Link>
        </div>
        ...
        <footer className="bg-slate-900 text-white pt-20 pb-10">
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="space-y-6">
              <Link href="/" className="flex items-center gap-2 font-bold text-primary text-3xl">
                <Droplet className="h-10 w-10 fill-primary" />
                <span className="tracking-tight font-headline">RoktoDao</span>
              </Link>
              <p className="text-slate-400 text-lg">
                A mission to connect blood donors with recipients.
              </p>
              <div className="text-2xl font-bold text-primary">+880 123 456 7890</div>
            </div>

            <div className="space-y-6">
              <h3 className="text-xl font-bold border-b border-slate-700 pb-3">গুরুত্বপূর্ণ লিংক</h3>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-bold border-b border-slate-700 pb-3">আইনি</h3>
              <ul className="space-y-3 text-slate-400">
